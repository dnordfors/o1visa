...
class ImmigrationOfficer:
    def __init__(self, resume):
        ...
        self.user_messages = [
            ...
            {
                'role': 'user',
                'content': 'how likely is it that publications of the said kind will have written about the applicant, based on the typical profiles of the people that occur in their stories?'
            },
            {
                'role': 'user',
